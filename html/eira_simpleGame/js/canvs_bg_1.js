var can_bg_main = document.getElementById( 'can_bg_main' ),
	ctx1 = can_bg_main.getContext( '2d' ),
	can_bg_reserved = document.getElementById( 'can_bg_reserved' ),
	ctx2 = can_bg_reserved.getContext( '2d' ),
	twopi = Math.PI * 2,
	parts = [],
	sizeBase,
	cw,
...
function loop() {
	...
	ctx2.shadowBlur = 0;
	ctx2.drawImage( can_bg_main, 0, 0 );
...
function resize() {
	cw = can_bg_main.width = can_bg_reserved.width = window.innerWidth,
	ch = can_bg_main.height = can_bg_reserved.height = window.innerHeight;
	create();
}
